...
> **分类**：编程语言 ｜ **章节总数**：150 ｜ **技术栈**：Java 21


## 领域概述

Java核心是编程语言领域的重要技术方向，本系列从基础到高级逐步深入，涵盖15个核心模块：Java基础、面向对象、集合框架、异常处理、泛型等。每个知识点作为独立章节，包含原理讲解、实现要点、常见陷阱和最佳实践，配合源码分析和架构图，帮助读者建立完整的Java核心知识体系。

本教程基于 **Java** 与 **Java 21** 生态编写，涵盖 JVM, Maven, Gradle 等主流工具与框架。每章独立成篇，文字精炼、逻辑清晰，适合系统学习与按需查阅。
