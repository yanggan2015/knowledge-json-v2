...
> **分类**：数据存储 ｜ **技术生态**：Kibana、Logstash、Beats、OpenSearch


## 领域定位

Elasticsearch 基于 Lucene 倒排索引，提供全文检索、聚合分析与近实时搜索。集群由 Master、Data、Coordinating 节点角色组成。

覆盖 mapping、分词、DSL 查询、分片副本与 ELK 日志栈。

本领域常用技术栈与工具包括：Kibana、Logstash、Beats、OpenSearch。
