...
> **分类**：数据存储 ｜ **技术生态**：MySQL、PostgreSQL、SQLite、教材《Database System Concepts》


## 领域定位

数据库原理涵盖关系模型、SQL、事务 ACID、并发控制与索引结构，是理解 MySQL、PostgreSQL 等具体产品的理论基础。

从范式、关系代数到锁与 MVCC，建立存储与查询优化的概念框架。

本领域常用技术栈与工具包括：MySQL、PostgreSQL、SQLite、教材《Database System Concepts》。
