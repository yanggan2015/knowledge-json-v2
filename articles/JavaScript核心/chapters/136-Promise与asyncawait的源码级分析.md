...
> **领域**：JavaScript核心 ｜ **模块**：Promise与async/await ｜ **难度**：高级 ｜ **类型**：源码分析
...
分析 ES2024 中 Promise与async/await 相关实现：
...
- 说清 **Promise与async/await的源码级分析** 在 JavaScript核心/Promise与async/await 中的定位。
...
---
*章节 ID: 136 ｜ 领域: JavaScript核心 ｜ 版本: 2.0*