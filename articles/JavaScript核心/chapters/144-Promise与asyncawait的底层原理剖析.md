...
> **领域**：JavaScript核心 ｜ **模块**：Promise与async/await ｜ **难度**：高级 ｜ **类型**：底层原理
...
Promise与async/await 最终转化为内存读写、系统调用、网络 I/O、线程调度。页大小、锁粒度、网络 RTT 等约束依然存在。
...
- 说清 **Promise与async/await的底层原理剖析** 在 JavaScript核心/Promise与async/await 中的定位。
...
---
*章节 ID: 144 ｜ 领域: JavaScript核心 ｜ 版本: 2.0*