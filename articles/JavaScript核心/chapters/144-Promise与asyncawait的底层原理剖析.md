...
本章系统讲解 **JavaScript核心** 中 **Promise与async/await** 的相关知识（底层原理）。本章从底层原理出发拆解 **Promise与async/await** 与运行时、内核或协议栈的交互。内容基于主流框架与工程实践撰写，不依赖过时概念堆砌。
