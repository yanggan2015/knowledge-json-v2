# 深入理解：同步机制在Linux内核中的应用

> **领域**：Linux内核 ｜ **模块**：同步机制 ｜ **难度**：进阶 ｜ **类型**：基础概念


## 导读

本章系统讲解 **Linux内核** 中 **同步机制** 的相关知识（基础概念）。本章建立 **同步机制** 的概念模型与工作原理，是后续专题章节的基础。内容基于主流框架与工程实践撰写，不依赖过时概念堆砌。
...
smp_mb/smp_rmb 防重排；atomic_t 与 cmpxchg 实现无锁计数。
