# 深入理解：系统调用与IPC在Linux内核中的应用

> **领域**：Linux内核 ｜ **模块**：系统调用与IPC ｜ **难度**：实战 ｜ **类型**：基础概念


## 导读

本章系统讲解 **Linux内核** 中 **系统调用与IPC** 的相关知识（基础概念）。本章建立 **系统调用与IPC** 的概念模型与工作原理，是后续专题章节的基础。内容基于主流框架与工程实践撰写，不依赖过时概念堆砌。
...
AF_UNIX 本机高效，SCM_RIGHTS 可传递 fd。
