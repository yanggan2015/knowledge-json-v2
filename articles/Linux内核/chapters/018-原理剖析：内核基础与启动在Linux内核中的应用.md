# 原理剖析：内核基础与启动在Linux内核中的应用

> **领域**：Linux内核 ｜ **模块**：内核基础与启动 ｜ **难度**：入门 ｜ **类型**：底层原理


## 导读

本章系统讲解 **Linux内核** 中 **内核基础与启动** 的相关知识（底层原理）。本章从底层原理出发拆解 **内核基础与启动** 与运行时、内核或协议栈的交互。内容基于主流框架与工程实践撰写，不依赖过时概念堆砌。
