...
本章系统讲解 **Linux内核** 中 **进程管理与调度** 的相关知识（基础概念）。本章建立 **进程管理与调度** 的概念模型与工作原理，是后续专题章节的基础。内容基于主流框架与工程实践撰写，不依赖过时概念堆砌。
...
copy_process 复制 task_struct 并 COW 页表；execve 替换地址空间加载 ELF。
