...
> **领域**：Serverless ｜ **模块**：AWS Lambda ｜ **难度**：进阶 ｜ **类型**：基础概念


## 导读

本章系统讲解 **Serverless** 中 **AWS Lambda** 的相关知识（基础概念）。本章建立 **AWS Lambda** 的概念模型与工作原理，是后续专题章节的基础。内容基于主流框架与工程实践撰写，不依赖过时概念堆砌。
