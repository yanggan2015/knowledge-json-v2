...
> **分类**：其他 ｜ **技术生态**：Unity, Unreal Engine, Godot, Blender, Photon


## 领域定位

游戏开发融合编程、美术、物理与 AI 等多学科。Unity 与 Unreal 是主流引擎，游戏循环、场景管理、物理碰撞与网络同步是核心系统。

面向游戏程序员，从引擎基础到性能优化与网络多人。

本领域常用技术栈与工具包括：Unity, Unreal Engine, Godot, Blender, Photon。
