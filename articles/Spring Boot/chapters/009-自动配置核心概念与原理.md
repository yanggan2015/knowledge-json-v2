...
> **领域**：Spring Boot ｜ **模块**：自动配置 ｜ **难度**：入门 ｜ **类型**：基础概念


## 导读

本章系统讲解 **Spring Boot** 中 **自动配置** 的相关知识（基础概念）。本章建立 **自动配置** 的概念模型与工作原理，是后续专题章节的基础。内容基于主流框架与工程实践撰写，不依赖过时概念堆砌。
