...
> **分类**：前端开发 ｜ **技术生态**：React 18、React Router、Redux/Zustand、Next.js、Vite、Testing Library


## 领域定位

React 是声明式 UI 库，以组件化、Fiber 架构与 Hooks 为核心。React 18 并发渲染、Suspense 与 Server Components 重塑现代 Web 应用开发模式。

覆盖 JSX、Hooks、Fiber 协调、性能优化、路由状态管理到 SSR/RSC，从 API 使用深入原理与工程实践。

本领域常用技术栈与工具包括：React 18、React Router、Redux/Zustand、Next.js、Vite、Testing Library。
